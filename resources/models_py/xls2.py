...
class GenerareMacheteXls_2(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        alg_params = {
            "FIELDS_MAPPING": [
                ...
                },
                {
                    "alias": None,
                    "comment": None,
                    "expression": '"CLASS_ID_INST_SUP"',
                    "length": 0,
                    "name": "CLASS_ID_INST_SUP",
                    "precision": 0,
                    "sub_type": 0,
                    "type": 10,
                    "type_name": "text",
        ...
        outputs["RefactorFieldsLinieJt"] = processing.run(
        ...
        alg_params = {
            "FIELDS_MAPPING": [
                ...
                },
                {
                    ...
                    "expression": "CLASS_ID_INST_SUP",
                    "length": 0,
                    "name": "ID_Descrierea instalatiei uperioare",
                    "precision": 0,
                    "sub_type": 0,
                    "type": 10,
                    "type_name": "text",
                },
                {
                    "alias": None,
                    "comment": None,
                    "expression": '"Descrierea instalatiei uperioare"',
                    "length": 0,
                    "name": "Descrierea instalatiei uperioare",
                    "precision": 0,
                    "sub_type": 0,
                    "type": 10,
                    "type_name": "text",
        ...
        outputs["RefactorFieldsGr"] = processing.run(
            "native:refactorfields",
            alg_params,
            context=context,
            feedback=feedback,
        ...
        alg_params = {
            "FIELDS_MAPPING": [
                ...
                },
                {
                    "alias": None,
                    "comment": None,
                    "expression": "CASE WHEN \"ROL_FIRI\" ='de bransament' THEN ('FB' || ' ' || \"STR\"|| ' ' ||\"NR\")\r\nELSE ('FR' || ' ' || \"STR\"|| ' ' ||\"NR\")\r\nEND",
                    "length": 0,
                    "name": "Descrierea BDI",
                    "precision": 0,
                    "sub_type": 0,
                ...
                },
                {
                    "alias": None,
                    "comment": None,
                    "expression": 'CASE WHEN "ID_LOC" IS NULL THEN "NR_CRT_LOC"\r\nELSE "ID_LOC"\r\nEND',
                    "length": 0,
                    "name": "ID_Locatia",
                    "precision": 0,
                    "sub_type": 0,
                ...
                },
                {
                    ...
                    "expression": "ID_INST_SUP",
                    "length": 0,
                    "name": "ID_Descrierea instalatiei superioare",
                    "precision": 0,
                    "sub_type": 0,
                    "type": 10,
                    "type_name": "text",
                ...
                },
                {
                    "alias": None,
                    "comment": None,
                    "expression": "TIP_FIRI_RET",
                    "length": 0,
                    "name": "Tip firida retea",
                    "precision": 0,
                    "sub_type": 0,
                    "type": 10,
                    "type_name": "text",
                ...
                },
                {
                    "alias": None,
                    "comment": None,
                    "expression": "TIP_FIRI_BR",
                    "length": 0,
                    "name": "Tip firida bransament",
                    "precision": 0,
                    "sub_type": 0,
                    "type": 10,
                    "type_name": "text",
                ...
                },
                {
                    ...
                    "expression": "AN_FUNC",
                    "length": 0,
                    "name": "Anul punerii în functiune",
                    "precision": 0,
                    "sub_type": 0,
                    "type": 10,
                    "type_name": "text",
        ...
        outputs["RefactorFieldsFr"] = processing.run(
            "native:refactorfields",
            alg_params,
            context=context,
            feedback=feedback,
        ...
        alg_params = {
            "FIELDS_MAPPING": [
                ...
                },
                {
                    "alias": None,
                    "comment": None,
                    "expression": "NR_CRT_PLC_BR",
                    "length": 0,
                    "name": "ID_PAPT/Nr.crt_Plecare bransament",
                    "precision": 0,
                    "sub_type": 0,
                    "type": 10,
                    "type_name": "text",
                ...
                },
                {
                    "alias": None,
                    "comment": None,
                    "expression": '"Tipul dispunerii"',
                    "length": 0,
                    "name": "Tipul dispunerii",
                    "precision": 0,
                    "sub_type": 0,
                    "type": 10,
                    "type_name": "text",
        ...
        outputs["RefactorFieldsBr"] = processing.run(
            "native:refactorfields",
            alg_params,
            context=context,
            feedback=feedback,
        ...
        outputs["JoinAttributesByFieldValueFrCuLinie"] = processing.run(
            "native:joinattributestable",
            alg_params,
            context=context,
            feedback=feedback,
        ...
        alg_params = {
            "FIELDS_MAPPING": [
                ...
                },
                {
                    "alias": None,
                    "comment": None,
                    "expression": '"ID_PAPT/Nr.crt_Plecare bransament"',
                    "length": 0,
                    "name": "ID_PAPT/Nr.crt_Plecare bransament",
                    "precision": 0,
                    "sub_type": 0,
        ...
        outputs["FieldCalculatorDescInstalatie"] = processing.run(
        ...
        outputs["FieldCalculatorIdLoc"] = processing.run(
            "native:fieldcalculator",
            alg_params,
            context=context,
            feedback=feedback,
