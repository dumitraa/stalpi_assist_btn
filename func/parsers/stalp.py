...
class IgeaStalpParser:
    def __init__(self, vector_layer):
        ...
        self.mapping = {
            ...
            "Strada": "str",
            "Tip circuit": "tip_cir",
            "Tip material": lambda st: "Portal" if st.desc_ctg_mt_jt in ["Portal"] else "Beton" if st.desc_ctg_mt_jt in ["SV 10001", "SV 10002", "SV 15011"] else "Metal" if "St. metalic" in st.desc_ctg_mt_jt else "Lemn" if "St. lemn" in st.desc_ctg_mt_jt else st.tip_mat,
